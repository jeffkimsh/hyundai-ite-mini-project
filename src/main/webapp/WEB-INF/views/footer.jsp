...
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/font_80.css" media="all">
    <link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/common.css?20220401" media="all">
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/layout.css?20220331" media="all">
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/popup.css?20210225" media="all">
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/jquery-ui.min.css" media="all">

<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/brand.css" media="all">
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/footer.css?20220406" media="all">
<link rel="stylesheet" type="text/css" href="http://thehandsome.com/_ui/desktop/common/css/contents.css?20220221" media="all">
<style type="text/css" media="print">
	@IMPORT url("http://thehandsome.com/_ui/desktop/common/blueprint/print.css");
</style>

<script async="" defer="" src="https://cdn.megadata.co.kr/dist/prod/enp_tracker_self_hosted.min.js"></script><script type="text/javascript" src="https://js.appboycdn.com/web-sdk/2.7/appboy.min.js" async=""></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-RPZ82BN53C&amp;l=dataLayer&amp;cx=c"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-5PCJDFJ"></script><script async="" src="https://www.google-analytics.com/analytics.js"></script><script src="https://connect.facebook.net/signals/config/1947530058811697?v=2.9.57&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script async="" charset="utf-8" src="//static.recopick.com/dist/production.min.js"></script><script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/jquery.vticker.js"></script><!-- 200318 ì¶ê° -->
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.commonResourcePath = "http://thehandsome.com/_ui/desktop/common";
			ACC.config.themeResourcePath = "http://thehandsome.com/_ui/desktop/theme-blue";
			ACC.config.siteResourcePath = "http://thehandsome.com/_ui/desktop/site-handsome";
			ACC.config.rootPath = "http://thehandsome.com/_ui/desktop";	
			ACC.config.CSRFToken = "689c2c47-cd64-4dc4-9d85-0209ddafb108";
...
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/common.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/html5shiv-printshiv.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/jquery.flexslider.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/ui.js?20211105"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/jquery.form-3.51.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/common_function.js?20220411"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/videojs-ie8.min.js"></script>
<!--[if lt IE 9]>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/html5shiv.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/handsome/respond.js"></script>
<![endif]-->
 
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/jquery-ui-1.11.2.min.js"></script>

<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/instagramAPI.js"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/makePCookie.js"></script>

<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/wisenut/js/jquery.min.js"></script>

<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/netfunnel.js" charset="UTF-8"></script>
<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/netfunnel_skin.js" charset="UTF-8"></script>

<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/unorm.js"></script>

<script type="text/javascript" src="http://thehandsome.com/_ui/desktop/common/js/appboy.min.js"></script>
<script type="text/javascript">
...
function getGAPageTitle(oneDepthPage){
    ...
    }else if(target_url.indexOf("/c/me031/ou") > -1){
    	returnTitle = oneDepthPage;
    	
        
        if("true"){
        	
        			if("ME031".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">재킷";
        			}
        		
        			if("ME032".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">점퍼";
        			}
        		
        			if("ME015".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">가디건/베스트";
        			}
        		
        			if("ME033".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">트렌치코트";
        			}
        		
        			if("ME034".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">코트";
        			}
        		
        			if("ME035".toLowerCase() == "me031".substring("me031".lastIndexOf("_")+1).toLowerCase()){
        				returnTitle += ">다운/패딩";
        			}
        		
        }
    }else if(target_url.indexOf("/c/me031/") > -1){
    	returnTitle = oneDepthPage;    	
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "http://www.thehandsome.com/ko/c/as011/";
...
<!-- 				        <img src="http://thehandsome.com/_ui/desktop/common/images/common/ico_apps_new.png" alt="APP 다운로드" style="width:54px;height:70px;"> -->
<p>APP 다운로드 &gt;</p>
			        </a>
			...
			<div class="cnts2_right">
				...
				<div id="noticeWrap" class="notice">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -18.7631px;"><li><a href="/ko/svcenter/notice?noticeCode=8803760787376">한섬 통합 멤버십 / (주)한섬 개인정보처리방침 개정 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803728019376">더한섬닷컴 서비스 정상화 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803793555376">[당첨자발표] 더한섬닷컴 3월 신규회원 댓글 이벤트 당첨자 발표</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803760820144">[당첨자발표] 더한섬닷컴 22년 3월 베스트 리뷰 TOP5 선정 안내</a></li></ul>
					</div>
				</div>
				<!-- //공지 -->
