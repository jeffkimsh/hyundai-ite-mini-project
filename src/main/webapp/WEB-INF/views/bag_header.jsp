...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"7ce8c950-ddb4-4b25-84c2-1220715aa486"},
            async : false,
...
$(document).ready(function() {
    ...
    if("" != ""){
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "cartPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
    ...
    <div class="gnb_sh_wrap" style="display:none;">
				...
				<div class="search_box_wrap sbw1803" id="searchBox">
                    <form name="search" id="search" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">           
                        <input type="hidden" name="CSRFToken" value="7ce8c950-ddb4-4b25-84c2-1220715aa486">
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="7ce8c950-ddb4-4b25-84c2-1220715aa486">
                ...
                <div class="util_menu" style="display:block;">
					<ul class="clearfix">
						...
						<a href="/ko/mypage" class="btn" onclick="GA_Event('공통','헤더_메뉴','마이페이지')">마이페이지</a>
							<div class="list" style="display: none; height: 168px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">
								<ul>
...
<input type="hidden" name="CSRFToken" value="7ce8c950-ddb4-4b25-84c2-1220715aa486">
        ...
        <h1 class="logo logo1903">
            <a href="/" onclick="">thehandsome.com</a>
        </h1>
        <!-- 첫번째 c:if -->
    ...
    <div class="util_menu util_menu1803">
        <ul class="clearfix">
            ...
            <li><a href="/ko/mypage/myWish" onclick="GA_Event('공통','유틸_메뉴','위시리스트');"><span class="ico wishlist">wish list</span> <span class="count"></span></a></li>
            <li><a href="/ko/shoppingbag" onclick="GA_Event('공통','유틸_메뉴','쇼핑백');"><span class="ico cart">장바구니</span> <span class="count"></span></a></li>
            </ul>
    </div>
  </div>  
    <!-- //201803 util menu -->
