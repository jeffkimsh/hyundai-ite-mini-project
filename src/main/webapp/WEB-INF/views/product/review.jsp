...
<div class="popwrap w_type_4" id="customerReviewWriteDiv">
    ...
    <div class="pop_cnt evaluation_write1905 options1811">
        <form id="reviewForm" name="reviewForm" action="/ko/HANDSOME/MEN/OUTER/JACKET/%5BORDINARY-FITS%5D-%ED%84%B1-%EB%8D%B0%EB%8B%98-%EC%9E%AC%ED%82%B7/p/HS2C3NJC002MOF_BL?categoryCode=me031" method="post" enctype="multipart/form-data"><input type="hidden" name="productCode">
                                                    ...
                                                    <ul class="select_options">
                                                        <li class="select_colors">
                                                            ...
                                                            <input type="hidden" id="colorName" value="BLUE">
	                                                                ...
	                                                                <input type="hidden" class="colorNameVal" value="BLUE">
	                                                                <a href="#;" class="beige" data-color="BLUE" style="background:#2250a2 url('http://newmedia.thehandsome.com/HS/2C/SS/HS2C3NJC002MOF_BL_C01.jpg/dims/resize/24x24');" onclick="javascript:fn_clickColorCode('HS2C3NJC002MOF_BL', 'BLUE');" onmouseover="setColorName('BLUE');" onmouseout="setColorName('');"></a>
	                                                            </li>
	                                                                        <li>
                                                    ...
                                                    <li class="select_size">
                                                        <p><span class="compulsory">*</span> 사이즈<!-- 사이즈 --></p>
                                                            <ul class="size_chip clearfix" id="review_size_btn_area">
                                                                ...
                                                                <a onclick="javascript:fn_clickSizeCode('HS2C3NJC002MOF_BL_100');">100</a>
                                                                            <productdetails:popupsizequickreference>
                                                                            </productdetails:popupsizequickreference></li>
                                                                        <li id="HS2C3NJC002MOF_BL_105">
                                                                <a onclick="javascript:fn_clickSizeCode('HS2C3NJC002MOF_BL_105');">105</a>
                                                                            </li>
                                                                        </ul>
        ...
        <div>
<input type="hidden" name="CSRFToken" value="689c2c47-cd64-4dc4-9d85-0209ddafb108">
</div></form></div>
