...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "34dd5460-cb84-41c6-beee-d8aa1f297db9";
...
<input type="hidden" name="CSRFToken" value="34dd5460-cb84-41c6-beee-d8aa1f297db9">
</div></form><!-- headerWrap -->
		<div id="headerWrap">
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"34dd5460-cb84-41c6-beee-d8aa1f297db9"},
            async : false,
            success:function(data){
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="34dd5460-cb84-41c6-beee-d8aa1f297db9">
...
var _jid = 'yearsk@naver.com' ;			// 가입시입력한 ID
</script>
<!-- AceCounter END -->
...
<div id="bodyWrap">
	<!--title-->
	<h3 class="cnts_title"><span>회원탈퇴</span></h3>
	<!--//title-->
	<!--join step-->
	...
	<div class="sub_container">
		<div class="join_title">
			<p class="title">회원탈퇴가 완료 되었습니다.</p>
			<p class="s_title">그동안 이용해주셔서 감사합니다.</p>
		</div>
			...
			<div class="cnts2_right">
				...
				<div id="noticeWrap" class="notice">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/svcenter/notice?noticeCode=8803793555376">[당첨자발표] 더한섬닷컴 3월 신규회원 댓글 이벤트 당첨자 발표</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803760820144">[당첨자발표] 더한섬닷컴 22년 3월 베스트 리뷰 TOP5 선정 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803760787376">한섬 통합 멤버십 / (주)한섬 개인정보처리방침 개정 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8803728019376">더한섬닷컴 서비스 정상화 안내</a></li></ul>
					</div>
				</div>
				<!-- //공지 -->
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1651563878319" type="text/javascript"></script>
